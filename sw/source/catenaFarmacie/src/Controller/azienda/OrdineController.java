...
public class OrdineController extends DBOrdine {
	...
	public static String visualizzatoUltimoStatoOrdine(int idOrdine) {
		/*utilizzato per avvisare l'azienda circa gli ordini non consegnati o consegnati in parte.
		Se gia è stata avvisata l'attributo visualizzato_stato_consegna diventa true per non fare visualizzare piu lo stesso avviso*/
